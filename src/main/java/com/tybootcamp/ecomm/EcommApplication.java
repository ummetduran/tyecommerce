...
public class EcommApplication implements CommandLineRunner {
    ...
    public EcommApplication(CategoryRepository _categoryRepository, ProductJpaRepository _productJpaRepository, SellerRepository _sellerRepository, CustomerRepository customerRepository) {
