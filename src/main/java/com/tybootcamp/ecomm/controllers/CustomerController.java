...
public class CustomerController {
    ...
    public ResponseEntity<Customer> addNewCustomer(@Valid @RequestBody Customer customer){
        ...
        Profile profile = new Profile(customerEntity, customer.getProfile().getFirstName(), customer.getProfile().getLastName(), customer.getProfile().getGender(),customer.getProfile().getUserType());
        ...
        customerEntity.getProfile().setEmailAddress(customer.getProfile().getAddress());
    ...
    public ResponseEntity<String> updateCustomer(@Valid @RequestBody Customer customer){
        ...
        customerEntity.getProfile().setUserType(customer.getProfile().getUserType());
        customerEntity = _customerRepository.save(customerEntity);
        System.out.println("__________________________________________________________________");
        System.out.println("The row of " + customerEntity.toString() + " updated");
        return new ResponseEntity<>("The customer upsated", HttpStatus.OK);
